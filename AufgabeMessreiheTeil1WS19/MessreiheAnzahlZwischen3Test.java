...
public class MessreiheAnzahlZwischen3Test {
    ...
    public void test01(){
        Assert.assertTrue(this.m33244 + " hat zwischen 2 und 4 genau 5 Werte"
                    + " berechnet wurde " +  this.m33244.anzahlZwischen3(2,4)
                , this.m33244.anzahlZwischen3(2,4) == 5);
    }    

    @Test
    public void test02(){
        Assert.assertTrue(this.m53532 + " hat zwischen 5 und 5 genau 2 Werte"
                    + " berechnet wurde " +  this.m53532.anzahlZwischen3(5,5)
                , this.m53532.anzahlZwischen3(5,5) == 2);
    }    

    @Test
    public void test03(){
        Assert.assertTrue(this.m2344 + " hat zwischen 5 und 4 genau 0 Werte"
                    + " berechnet wurde " +  this.m2344.anzahlZwischen3(5,4)
                , this.m2344.anzahlZwischen3(5,4) == 0);
    }     

    @Test
    public void test04(){
        Assert.assertTrue(this.leer + " hat zwischen 0 und 9 genau 0 Werte"
                    + " berechnet wurde " +  this.leer.anzahlZwischen3(0,9)
                , this.leer.anzahlZwischen3(0,9) == 0);
    } 

    @Test
    public void test05(){
        Assert.assertTrue(this.mitNullListe + " hat zwischen 1 und 5 genau 0 Werte"
                    + " berechnet wurde " +  this.mitNullListe.anzahlZwischen3(1,5)
                , this.mitNullListe.anzahlZwischen3(1,5) == 0);
    }
}
